...
const Header = () => {
  ...
  return (
    <motion.header
      ...
      className="bg-transparent shadow-lg fixed w-full top-0 z-50 right-0 text-emerald-500 px-4 sm:px-6 lg:px-16"
    >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-emerald-600 p-4 space-y-4"
          >
            ...
            <div className="space-y-4">
              <Link to="/register">
                <motion.button
                  className="w-full bg-white text-emerald-500 px-6 py-3 rounded-full hover:bg-emerald-100 transition duration-300 font-semibold"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Sign Up
              ...
              <Link to="/log-in">
                <motion.button
                  className="w-full bg-emerald-600 text-white px-6 py-3 rounded-full hover:bg-emerald-700 transition duration-300 font-semibold"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Log In
              ...
              {userRole && (
                <motion.button
                  className="w-full bg-green-500 text-white px-6 py-3 rounded-full hover:bg-green-600 transition duration-300 font-semibold"
                  onClick={handleLogout}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
